...
class ProductRequestController extends Controller
{
    ...
    public function importirRequestForm()
    {
        ...
        return view('importir.request-form', compact('pendingRequests', 'approvedRequests'));
    }

    /**
     * Store new request from importir
     */
    public function storeImportirRequest(Request $request)
    {
        $request->validate([
    ...
    public function eksportirRequestList()
    {
        ...
        return view('eksportir.request-list', compact('pendingRequests', 'myRequests'));
    }
