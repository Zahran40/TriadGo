            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="{{ route('home.eksportir') }}" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
                                    ...
                                    <div class="flex justify-between items-start mb-4">
                                        <div class="flex-1">
                                            <div class="flex items-center mb-2">
                                                <img src="{{ asset('default-avatar.png') }}" alt="User Avatar" class="w-8 h-8 rounded-full mr-3">
                                                <div>
                                                    <h4 class="font-medium text-gray-900 dark:text-white">{{ $request->importir->name }}</h4>
                                                    <p class="text-xs text-gray-500 dark:text-gray-400">{{ $request->importir->email }}</p>
                                                </div>
                                            </div>
