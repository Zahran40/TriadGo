<x-filament-panels::page>
    <div class="space-y-6">
        ...
        <!-- Description Card -->
        <div
            class="bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-800 rounded-lg p-4 mb-6">
            <div class="flex">
                <div class="flex-shrink-0">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-indigo-700 dark:text-indigo-300">
                        <p>
                            Monitor all orders made by importers. This page is for <strong>viewing</strong> only - 
                            You can view order details, payment status, and customer information without being able to
                            edit or delete data.
                        </p>
                    </div>
                </div>
