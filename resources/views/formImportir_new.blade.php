                            ...
                            <div class="space-y-3">
                                <div class="custom-radio">
                                    <label
                                        ...
                                        <div class="flex-1">
                                            <div class="font-semibold text-blue-900 dark:text-blue-100">Midtrans Payment
                                                Gateway</div>
                                            <div class="text-sm text-gray-600 dark:text-gray-300">Secure payment via
                                                Midtrans (Credit Card, Bank Transfer, E-Wallet)</div>
                                        </div>
