...
<body>
    <div class="tracking-container">
        ...
        <div class="tracking-header">
            <div class="tracking-title">🚢 Track Shipping</div>
            <div class="tracking-subtitle">Track your package across the ocean</div>
        </div>
            ...
            <div class="order-details">
                ...
                <div class="order-detail-item">
                    ...
                    <div class="order-detail-value">
                        <span
                            class="status-badge {{ $order->status == 'paid' ? 'status-completed' : 'status-pending' }}">
        ...
        <div class="status-section">
            <div class="tracking-status-title">📍 Shipment Status</div>
            <div class="timeline" id="timeline">
                ...
                <svg class="ocean-wave" viewBox="0 0 80 400" preserveAspectRatio="none">
                    ...
                    <path d="M0,20 Q20,0 40,20 T80,20 L80,400 L0,400 Z" fill="url(#oceanGrad)"
                        filter="url(#wave-shadow)" opacity="0.8">
                        <animate attributeName="d" values="M0,20 Q20,0 40,20 T80,20 L80,400 L0,400 Z;
                                         M0,10 Q20,30 40,10 T80,10 L80,400 L0,400 Z;
                                         M0,20 Q20,0 40,20 T80,20 L80,400 L0,400 Z" dur="4s"
                ...
                <div id="cruiseShip" class="cruise-ship" style="top: 20px;">
                    <svg viewBox="0 0 64 64" width="64" height="64" fill="none">
                        ...
                        <!-- Ship Hull -->
                        <path d="M8 42 L56 42 Q52 52 32 54 Q12 52 8 42 Z" fill="#1e293b" stroke="#0f172a"
                            stroke-width="2" />

                        <!-- Ship Deck -->
                        <rect x="12" y="36" width="40" height="6" rx="3" fill="#3b82f6" stroke="#1e40af"
                            stroke-width="1.5" />

                        <!-- Containers -->
                        <rect x="14" y="28" width="8" height="8" rx="2" fill="#fbbf24" stroke="#d97706"
                            stroke-width="1.5" />
                        <rect x="24" y="26" width="8" height="10" rx="2" fill="#f87171" stroke="#dc2626"
                            stroke-width="1.5" />
                        <rect x="34" y="27" width="8" height="9" rx="2" fill="#34d399" stroke="#059669"
                            stroke-width="1.5" />
                        <rect x="44" y="29" width="6" height="7" rx="2" fill="#60a5fa" stroke="#2563eb"
                            stroke-width="1.5" />

                        <!-- Ship Bridge -->
                        <rect x="48" y="18" width="6" height="12" rx="2" fill="#1e40af" stroke="#1e3a8a"
                            stroke-width="1.5" />
                        ...
                        <polygon points="54,18 58,18 58,22 54,20" fill="#dc2626" opacity="0.9">
                            <animateTransform attributeName="transform" type="rotate"
                                values="0 56 20;5 56 20;-5 56 20;0 56 20" dur="3s" repeatCount="indefinite" />
                        </polygon>
                    </svg>
                </div>
                ...
                <div class="ship-container"
                    style="position: absolute; left: -80px; width: 80px; height: 100%; z-index: 10;">
                    @php
                    ...
                    ">
                        <svg width="60" height="60" viewBox="0 0 100 100" class="ship-svg">
                            ...
                            <!-- Sail -->
                            <path d="M30 35 Q 35 25, 45 35 L 45 50 L 30 50 Z" fill="#f3f4f6" stroke="#d1d5db"
                                stroke-width="1" />
                            <!-- Flag -->
                            ...
                            <ellipse cx="50" cy="80" rx="40" ry="8" fill="#60a5fa" opacity="0.4">
                                ...
                                <animate attributeName="opacity" values="0.4;0.6;0.4" dur="3s"
                                    repeatCount="indefinite" />
                            </ellipse>

                            <!-- Floating Animation -->
                            <animateTransform attributeName="transform" type="translate"
                                values="0,0; 2,-1; 0,0; -2,1; 0,0" dur="4s" repeatCount="indefinite" />
                        </svg>
                    </div>
                ...
                @php
                    $steps = [
                        [
                            'title' => '🏭 Order Received at Warehouse',
                        ...
                        [
                            'title' => '🌊 Shipping To Destinated Country',
                ...
                @foreach($steps as $index => $step)
                    <div
                        class="timeline-step {{ $index < $currentStep ? 'completed' : ($index == $currentStep ? 'active' : '') }}">
                        <div
                            class="timeline-step-title {{ $index < $currentStep ? 'completed' : ($index > $currentStep ? 'gray' : '') }}">
                            {{ $step['title'] }}
                        </div>
                        ...
                        <span
                            class="status-badge {{ $index < $currentStep ? 'status-completed' : ($index == $currentStep ? 'status-active' : 'status-pending') }}">
